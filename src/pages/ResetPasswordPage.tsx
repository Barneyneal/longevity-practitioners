        ...
        {message ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className={`w-full h-12 text-white font-semibold rounded-full transition-colors duration-300 ${loading || !token ? 'bg-blue-500 cursor-wait' : 'bg-blue-600 hover:bg-blue-700'}`}
            >
              {loading ? (
